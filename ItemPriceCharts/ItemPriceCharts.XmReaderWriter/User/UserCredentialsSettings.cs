...
namespace ItemPriceCharts.XmReaderWriter.User
{
    public static class UserCredentialsSettings
    {
        ...
        public static void SetSettubgs()
        {
        ...
        public static bool ShouldEnableAutoLogin(out string email)
        {
            email = Email;

            return bool.TryParse(RememberAccount, out var shouldRememberAccount) &&
